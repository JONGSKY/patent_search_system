...
// document.getElementById("chart_div").onclick = function(evt){
//             var activePoints = chart_div.getElementsAtEvent(evt);
//             var firstPoint = activePoints[0];
//             var label = chart_div.data.labels[firstPoint._index];
//             var value = chart_div.data.datasets[firstPoint._datasetIndex].data[firstPoint._index];
//             alert(label + ": " + value);
//         };
// $("#chart_div").click(
//     function(evt){
//         var activePoints = chart_div.getSegmentsAtEvent(evt);
//         alert('hi');
//         alert(activePoints);
//
//         /* do something */
